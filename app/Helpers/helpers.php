...
if (!function_exists('w2img')) {
   function w2img($path)
   {
      return asset('assets/admin/img/' . $path);
   }
}
if (!function_exists('w2css')) {
   function w2css($path)
   {
      return asset('assets/admin/css/' . $path);
   }
}
if (!function_exists('w2js')) {
   function w2js($path)
   {
      return asset('assets/admin/js/' . $path);
   }
}
...
if (!function_exists('pw2img')) {
   ...
   {
      return asset('assets/page/img/' . $path);
   }
}
if (!function_exists('pw2css')) {
   function pw2css($path)
   {
      return asset('assets/page/css/' . $path);
   }
}
if (! function_exists('pw2font')) {
    function pw2font($path) {
        return asset('assets/page/fonts/'.$path);
    }
}
if (!function_exists('pw2fonts')) {
   function pw2fonts($path)
   {
      return asset('assets/page/fonts/' . $path);
   }
}
if (!function_exists('pw2js')) {
   function pw2js($path)
   {
      return asset('assets/page/js/' . $path);
   }
}
